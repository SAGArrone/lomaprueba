...
class ResPartner(models.Model):
    ...
    # ===================================================================
    # Separo esto para poder heredar de otros modulos y extender los datos
    # ===================================================================
    def parce_census_vals(self, census):
        ...
        # Definimos impuesto a las ganancias
        ...
        if census.provincia:
            ...
            # Si encontramos la provincia la asignamos
            if state:
                vals["state_id"] = state.id

        # Definimos el valor adecuado para el IVA
        ...
        # Retornamos los datos procesados del cliente en cuestión
        return vals

    # ===================================================================
    # Función IMPORTANTE: se comunica con la AFIP vía webservices y trae los datos del cuit del cliente
    # ===================================================================
    def get_data_from_padron_afip(self):
        ...
        env_type = company._get_environment_type_padron()

        try:
            certificate = company.get_key_and_certificate(env_type)
        except Exception:
