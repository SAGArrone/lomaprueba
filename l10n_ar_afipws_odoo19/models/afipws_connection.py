...
class AfipwsConnection(models.Model):
    ...
    afip_ws = fields.Selection(
        [
            ...
            ("ws_sr_constancia_inscripcion", "Servicio de reemplazo de Alcance 5"),
    ...
    @api.model
    def _ensure_pyafipws_python312_compatibility(self):
    ...
    def _get_ws(self, afip_ws):
        ...
        self._ensure_pyafipws_python312_compatibility()
