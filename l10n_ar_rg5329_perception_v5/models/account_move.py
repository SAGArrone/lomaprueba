...
class AccountMove(models.Model):
    ...
    def _l10n_ar_rg5329_invoice_base_lines(self):
        ...
        Therefore, do not exclude a line only because display_type has a value.
        We inspect both invoice_line_ids and line_ids because during onchange/web_save
        one of them may be more up to date than the other.
        """
        self.ensure_one()
        ...
        _logger.info("===== DEBUG RG5329 LINEAS V5.2 =====")
        _logger.info(
