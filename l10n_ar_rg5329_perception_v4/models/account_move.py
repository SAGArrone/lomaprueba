...
class AccountMove(models.Model):
    ...
    def _l10n_ar_rg5329_line_base_amount(self, line):
        ...
        if not amount and line.quantity and line.price_unit:
            amount = line.quantity * line.price_unit * (1.0 - (line.discount or 0.0) / 100.0)
        return amount
    ...
    def _l10n_ar_rg5329_sync_invoice_taxes(self):
        for move in self:
            ...
            for line in move._l10n_ar_rg5329_invoice_product_lines():
                taxes = company._l10n_ar_rg5329_base_taxes(line.tax_ids)
                rate_key = company._l10n_ar_rg5329_rate_key_from_taxes(taxes)
                should_apply = (
                ...
                if should_apply and tax_by_rate.get(rate_key):
